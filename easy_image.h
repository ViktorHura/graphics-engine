...
namespace img
{
	...
	class EasyImage
	{
		public:
            ...
            void draw_lineZ(unsigned int x0, unsigned int y0, double z0, unsigned int x1, unsigned int y1, double z1, ZBuffer &zbuf, Color color);
